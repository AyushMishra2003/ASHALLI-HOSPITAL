  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-8">
          <div className="flex flex-col lg:flex-row items-start gap-8">
            ...
            <div className="flex-1">
              <h1 className="text-3xl font-bold text-[#18978d] mb-2">Dr. Priya S P Patil</h1>
      ...
      <div className="fixed bottom-4 right-4">
        <div className="bg-[#18978d] text-white p-3 rounded-full shadow-lg cursor-pointer hover:bg-[#147a6b] transition duration-200">
          <div className="w-6 h-6 flex items-center justify-center">💬</div>
        </div>
        <div className="absolute bottom-16 right-0 bg-white shadow-lg rounded-lg p-3 text-sm text-gray-600 whitespace-nowrap">
          We're Online!<br />
