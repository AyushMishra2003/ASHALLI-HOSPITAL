...
const SlidingBanner = () => {
  ...
  const keywords = [
    ...
    "Karnataka's Only AAGL Accredited Centre",
  ...
  return (
    <div 
      className=" bg-[#18978d] overflow-hidden relative py-3"
    ...
    >
      ...
      >
        {duplicatedKeywords.map((keyword, index) => (
          <div
            key={index}
            className="inline-flex items-center  text-white px-6 py-3 mx-4 rounded-full font-semibold text-sm md:text-base lg:text-lg hover:from-red-500 hover:to-red-600 transition-all duration-300 cursor-pointer transform hover:scale-105 relative group"
          >
            {/* Checkmark icon */}
