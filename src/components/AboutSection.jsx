...
const AboutSection = () => {
  ...
  return (
    ...
    <div className=" py-10 sm:py-12 md:py-14 lg:py-10   lg:px-12 px-4 sm:px-6 md:px-8  " style={{ backgroundColor: '#e8f4f8' }}>
      <div className=" mx-auto container">
        ...
        <div className=" ">
          <div className="prose prose-lg max-w-none">
            <p className="text-gray-700 leading-relaxed mb-6 text-lg text-justify lg:text-left">
